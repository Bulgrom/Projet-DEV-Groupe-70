...
//TODO : liste commandes, faire un héritage d'interface ou des booleens? faudra voir avec ability
...
public class Controller {
	...
	public Controller(Case[][] listCase, PartyInterface partyInterface) {
		...
		System.out.println("C'est à " + currentCharacter.getName() + ", controllé par " + partyInterface.getCurrentPlayer() 
		+ " de commencer !");
	}
